...
dictlabel = zip(shapes, values)
#showlabel = []
#for y in dictlabel:
#    showlabel.append(str(y.index()) + str(y.) + 'mS')
#dictlabel = str(labels) + str(sizes) + 'mS'

print dictlabel
ax2.legend(patches, dictlabel, loc='upper left')
ax2.set_title('Unit: ms', loc='left')
